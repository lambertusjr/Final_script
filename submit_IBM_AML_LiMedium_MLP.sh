#!/bin/bash
#PBS -N IBM_AML_LiMedium_MLP
#PBS -l select=1:ncpus=4:mem=128GB:ngpus=1:Qlist=ee:host=comp056
#PBS -q ee
...
MODEL="MLP"
LOGFILE="${PBS_O_WORKDIR}/output_IBM_AML_LiMedium_MLP.out"
exec > "${LOGFILE}" 2>&1
...
DATASET_DIR="Datasets/IBM_AML_dataset/LiMedium"
